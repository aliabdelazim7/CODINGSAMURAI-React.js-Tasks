    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">MiniStore</h3>
          ...
          <div>
            ...
            <p className="text-gray-300">Email: support@ministore.com</p>
            <p className="text-gray-300">Phone: (555) 123-4567</p>
            <div className="mt-4">
              <h4 className="text-md font-medium text-gray-200 mb-2">Developer</h4>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            &copy; 2024 MiniStore. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
